...
- React 16 routing basics with [react router](https://reacttraining.com/react-router/).
- An upgrade of this [project](https://github.com/martin-corevski/react-basics-http).
